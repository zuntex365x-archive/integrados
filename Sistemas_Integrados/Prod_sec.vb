...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Prod_Sec))
        ...
        'Emp
        '
        Me.Emp.Items.AddRange(New Object() {"TEXSUN", "TODOS"})
        Me.Emp.Location = New System.Drawing.Point(328, 9)
        Me.Emp.MaxLength = 20
        Me.Emp.Name = "Emp"
        Me.Emp.Size = New System.Drawing.Size(174, 24)
        Me.Emp.TabIndex = 67
        Me.ToolTip1.SetToolTip(Me.Emp, "Lista de Clientes")
        '
        'Imprime
        '
        ...
        Me.Text = "Produccion Diaria por Seccion (JT + TRECENTO + ZUNTEX)"
...
#End Region
    ...
    Private Sub produccion(ByVal cnn As SqlClient.SqlConnection)
        ...
        If Emp.SelectedIndex = 0 Then
            strSQL = "SELECT FECHA, SUM(PRENDAS) AS PRENDA, SECCION FROM PROD_DIARIA,CORTES WHERE MONTH(FECHA) = '" & mes & "' AND YEAR(FECHA) ='" & ano & "' AND PROD_DIARIA.CORTE = CORTES.CORTE AND SECCION LIKE '" & Trim(Emp.Text) & "%' GROUP BY SECCION,FECHA ORDER BY SECCION"

        Else
            strSQL = "SELECT FECHA, SUM(PRENDAS) AS PRENDA, SECCION FROM PROD_DIARIA,CORTES WHERE MONTH(FECHA) = '" & mes & "' AND YEAR(FECHA) ='" & ano & "' AND PROD_DIARIA.CORTE = CORTES.CORTE  GROUP BY SECCION,FECHA ORDER BY SECCION"
        End If
        dt = New DataTable
        Dim dr As DataRow
    ...
    Private Sub Print_fg()
        ...
        Dim fecha As String
        Dim empresa As String = Emp.Text
        ...
        fg.PrintGrid("Telas", PrintGridFlags.FitToPageWidth + PrintGridFlags.ShowPrintDialog, "Reporte de prendas producidas. Empresa: " + empresa + "  del mes:  " + fecha_i.Text + Chr(9) + Chr(9) + "Pagina {0}", "")
    End Sub
