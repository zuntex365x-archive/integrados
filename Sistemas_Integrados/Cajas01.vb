...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.S1.Location = New System.Drawing.Point(1029, 7)
        Me.S1.Name = "S1"
...
#End Region
    Private Sub Cortes_status(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        llena_combos(CORTE, "SELECT CORTE FROM CORTES WHERE EXPORTADO  <> 'S' AND CORTE NOT IN (SELECT CORTE FROM CAJAS01) AND LEFT(CORTE,4) <> '200-' AND (SECCION LIKE 'TEX%' OR SECCION LIKE 'INNO%') ORDER BY CORTE", "CORTE")
    ...
    Private Sub graba_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles graba.Click
        ...
        If seguro = MsgBoxResult.Yes Then
            graba_datos()
            ok = imprime_cajas(inicial, final)
            Close()
        End If
    End Sub
