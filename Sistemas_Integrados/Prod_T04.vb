...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Prod_T04))
        ...
        Me.Text = "Crea Listas de Empaque ( Primeras )"
...
#End Region
    Private Overloads Sub Bal_tela_Det(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        llena_combos(cliente, "SELECT DISTINCT CLIENTE FROM PROD_TER01 WHERE TIPO = 'P' AND ESTADO = 'A' ORDER BY CLIENTE ", "CLIENTE")
        setea_fg()
        setea_co()
    End Sub
    ...
    Private Sub llena_fg()
        ...
        Dim dr As DataRow
        Dim l As Integer = 1
        Dim strsql As String = "SELECT CPO,ESTILO,COLOR,PROD_TER01.CORTE AS CORTE , SUM(UNIDADES) FROM PROD_TER01 LEFT JOIN CORTES ON PROD_TER01.CORTE = CORTES.CORTE WHERE PROD_TER01.CLIENTE = '" & cliente.Text & "' AND TIPO = 'P' AND ESTADO = 'A' GROUP BY CPO,ESTILO,COLOR,PROD_TER01.CORTE ORDER BY CPO,ESTILO,COLOR,PROD_TER01.CORTE"
    ...
    Private Sub crea(ByVal fila As Integer)
        ...
        Dim strsql As String = "SELECT * FROM PROD_TER01 LEFT JOIN CORTES ON PROD_TER01.CORTE = CORTES.CORTE WHERE PROD_TER01.CORTE = '" & corte & "' AND TIPO = 'P' AND ESTADO = 'A' AND CAJA NOT IN (SELECT CAJA FROM PROD_TER01 WHERE CORTE = '" & corte & "' AND TIPO = 'S') ORDER BY CAJA"
        llena_tablas(dt, strsql, cnn)
