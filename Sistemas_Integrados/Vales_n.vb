...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(Vales_n))
...
#End Region
    ...
    Private Sub FPO_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        llena_combos(cortes, "SELECT  DISTINCT CORTE FROM CORTES WHERE CORTE NOT IN (SELECT DISTINCT CORTE FROM CAJAS01) AND CORTE NOT IN (SELECT DISTINCT CORTE FROM PROD_DIARIA) AND EXPORTADO <> 'S' AND TOTAL > 0 ", "CORTE")
    ...
    Private Sub revisa_corte(ByVal corte As String, ByVal l As Integer, ByRef si As Boolean)
        ...
        Dim pro As Integer
        Dim exp As Integer
        llena_tablas(dt, "SELECT * FROM CORTES WHERE CORTE = '" & corte & "'", cnn)
    ...
    Private Sub busca_corte()
        ...
        Dim i As Integer
        Dim tal As String
        Dim strsql As String = "SELECT CORTE,E_TALLAS.ESCALA,T1,T2,T3,T4,T5,T6,T7,T8,T9,T0 FROM CORTES LEFT JOIN CPO_D ON CORTES.CPO = CPO_D.CPO AND CORTES.ESTILO = CPO_D.ESTILO AND CORTES.COLOR = CPO_D.COLOR LEFT JOIN E_TALLAS ON CPO_D.ESCALA = E_TALLAS.ESCALA WHERE CORTE = '" & cortes.Text & "'"
