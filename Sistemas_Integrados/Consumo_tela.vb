...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents Codigos As System.Windows.Forms.TextBox
    Friend WithEvents Descripcion As System.Windows.Forms.TextBox
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.components = New System.ComponentModel.Container()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Consumo_tela))
        ...
        Me.Codigos = New System.Windows.Forms.TextBox()
        ...
        Me.Descripcion.Location = New System.Drawing.Point(304, 96)
        ...
        Me.Ct.Location = New System.Drawing.Point(264, 104)
        Me.Ct.Name = "Ct"
        ...
        Me.Codigos.Enabled = False
        Me.Codigos.ForeColor = System.Drawing.Color.Black
        Me.Codigos.Location = New System.Drawing.Point(168, 96)
        Me.Codigos.Name = "Codigos"
        Me.Codigos.ReadOnly = True
        Me.Codigos.Size = New System.Drawing.Size(88, 20)
        Me.Codigos.TabIndex = 59
        '
        'Label7
        '
        ...
        Me.Label7.Text = "Todos los Colores"
        '
        'CheckBox1
        '
        Me.CheckBox1.Location = New System.Drawing.Point(632, 120)
        ...
        Me.colort.Location = New System.Drawing.Point(632, 96)
        Me.colort.MaxLength = 25
        Me.colort.Name = "colort"
        Me.colort.Size = New System.Drawing.Size(232, 21)
        ...
        Me.Label6.Location = New System.Drawing.Point(584, 96)
        ...
        Me.Unidad.Location = New System.Drawing.Point(168, 120)
        Me.Unidad.MaxLength = 10
        Me.Unidad.Name = "Unidad"
        Me.Unidad.Size = New System.Drawing.Size(88, 20)
...
#End Region
    ...
    Private Sub Expo_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        AddHandler Unidad.KeyPress, AddressOf keypressed4
    ...
    Private Sub revisa_detalle(ByRef ok As Boolean)
        ...
        End Try
        If Not ok Then
            MsgBox("Error en Libras", MsgBoxStyle.Critical, "Por favor revise !!!")
        End If
    End Sub
    ...
    Private Sub llena_colores()
        ...
        'llena_combos(colort, strSQL, "COLOR")
        If Colo.Items.Count > 0 Then
            Colo.SelectedIndex = 0
            'colort.SelectedIndex = 0
        End If
    End Sub
    ...
    Private Sub CheckBox1_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CheckBox1.CheckedChanged
        llena_colorest(CheckBox1.Checked)
    End Sub

    Private Sub llena_colorest(ByVal todos As Boolean)
        Dim strSQL As String
        If Not todos Then
            strSQL = "SELECT DISTINCT COLOR  FROM CPO_D,CPO WHERE CPO.CPO = CPO_D.CPO AND CLIENTE = '" & Cliente.Text & "' ORDER BY COLOR"
        Else
            strSQL = "SELECT COLOR  FROM COLORES ORDER BY COLOR"
        End If
        llena_combos(colort, strSQL, "COLOR")
    End Sub
    ...
    Private Sub colort_leave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles colort.Leave
        If colort.Items.IndexOf(colort.Text) = -1 Then
            colort.Focus()
        End If
    End Sub
