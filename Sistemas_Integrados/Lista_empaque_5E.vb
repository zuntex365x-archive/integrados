...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Lista_empaque_5E))
        ...
        Me.motivo.Location = New System.Drawing.Point(540, 6)
        Me.motivo.Name = "motivo"
        Me.motivo.Size = New System.Drawing.Size(339, 28)
        Me.motivo.TabIndex = 88
        ...
        Me.Embarque.Location = New System.Drawing.Point(134, 6)
        Me.Embarque.Name = "Embarque"
        Me.Embarque.Size = New System.Drawing.Size(200, 28)
        Me.Embarque.TabIndex = 87
        ...
        Me.Name = "Lista_empaque_5E"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Elimina Lista empque de Segundas."
...
#End Region
    ...
    Private Sub llena_empaque()
        llena_combos(Embarque, "SELECT DISTINCT EMBARQUE, FECHA FROM PACKING_E WHERE (FACTURADO IS NULL) OR (FACTURADO = 'N') AND EMBARQUE LIKE 'SEG-%' ORDER BY FECHA DESC", "EMBARQUE")
        Try
    ...
    Private Sub elimina_datos()
        ...
        Try
            ...
            For Each Me.dr In dt.Rows
                ...
                For j = 8 To 17
                    If dr(j) > 0 Then
                        strsql = "UPDATE STOCK SET UNIDADES = UNIDADES + " & dr(j) & " WHERE ESTILO = '" & estilo & "' AND COLOR = '" & colores & "' AND TIPO = '01' AND TALLA = '" & ts(j - 8) & "'"
                        comando.CommandText = strsql
                        afectados = comando.ExecuteNonQuery()

                        strsql = "UPDATE E_STOCK SET EXPORT = EXPORT - " & dr(j) & " WHERE CORTE = '" & corte & "' AND ESTILO = '" & estilo & "' AND COLOR = '" & colores & "' AND TIPO = '01' AND TALLA = '" & ts(j - 8) & "'"
                        comando.CommandText = strsql
                        afectados = comando.ExecuteNonQuery()
                    End If
                Next j
