...
Public Class ContribucionLavanderia
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(ContribucionLavanderia))
        ...
        Me.Name = "ContribucionLavanderia"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Contribución por Planilla"
...
#End Region
    ...
    Dim em As Integer
    Dim ctot As Integer
    Private Sub ContribucionLavanderia_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub print_fg()
        ...
        fg.PrintGrid("ContribucionLavanderia", PrintGridFlags.FitToPageWidth + PrintGridFlags.ShowPreviewDialog, "Resumen de Costos Planilla  " & plan.Text + "     " + Label1.Text + Chr(9) + Chr(9) + "Pagina {0}", "")
    End Sub

    Private Sub excel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles excel.Click
        Dim ok As Boolean
        a_excel(fg, "c:\reportes\ContribucionLavanderia.xls", ok)
        If ok Then
            Close()
        End If
    End Sub
