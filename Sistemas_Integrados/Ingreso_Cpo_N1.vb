...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Ingreso_cpo_N1))
        ...
        'Label1
        '
        Me.Label1.BackColor = System.Drawing.Color.FromArgb(CType(CType(120, Byte), Integer), CType(CType(228, Byte), Integer), CType(CType(158, Byte), Integer))
        ...
        'Label9
        '
        Me.Label9.BackColor = System.Drawing.Color.FromArgb(CType(CType(120, Byte), Integer), CType(CType(228, Byte), Integer), CType(CType(158, Byte), Integer))
        ...
        'Label5
        '
        Me.Label5.BackColor = System.Drawing.Color.FromArgb(CType(CType(120, Byte), Integer), CType(CType(228, Byte), Integer), CType(CType(158, Byte), Integer))
        ...
        'Label7
        '
        Me.Label7.BackColor = System.Drawing.Color.FromArgb(CType(CType(120, Byte), Integer), CType(CType(228, Byte), Integer), CType(CType(158, Byte), Integer))
        ...
        'Label8
        '
        Me.Label8.BackColor = System.Drawing.Color.FromArgb(CType(CType(120, Byte), Integer), CType(CType(228, Byte), Integer), CType(CType(158, Byte), Integer))
        ...
        'Label11
        '
        Me.Label11.BackColor = System.Drawing.Color.FromArgb(CType(CType(120, Byte), Integer), CType(CType(228, Byte), Integer), CType(CType(158, Byte), Integer))
        ...
        'Label22
        '
        Me.Label22.BackColor = System.Drawing.Color.FromArgb(CType(CType(120, Byte), Integer), CType(CType(228, Byte), Integer), CType(CType(158, Byte), Integer))
        ...
        'Label2
        '
        Me.Label2.BackColor = System.Drawing.Color.FromArgb(CType(CType(120, Byte), Integer), CType(CType(228, Byte), Integer), CType(CType(158, Byte), Integer))
        ...
        'Label24
        '
        Me.Label24.BackColor = System.Drawing.Color.FromArgb(CType(CType(120, Byte), Integer), CType(CType(228, Byte), Integer), CType(CType(158, Byte), Integer))
        ...
        'Label25
        '
        Me.Label25.BackColor = System.Drawing.Color.FromArgb(CType(CType(120, Byte), Integer), CType(CType(228, Byte), Integer), CType(CType(158, Byte), Integer))
        ...
        'Label3
        '
        Me.Label3.BackColor = System.Drawing.Color.FromArgb(CType(CType(120, Byte), Integer), CType(CType(228, Byte), Integer), CType(CType(158, Byte), Integer))
        ...
        'Label4
        '
        Me.Label4.BackColor = System.Drawing.Color.FromArgb(CType(CType(120, Byte), Integer), CType(CType(228, Byte), Integer), CType(CType(158, Byte), Integer))
...
#End Region
    ...
    Private Sub llena_grid()
        ...
        Dim dr As DataRow
        ok = False
        Dim strSQL As String = "SELECT CPO_D1.*, CLIENTE FROM CPO_D1  LEFT JOIN CPO_1 ON CPO_D1.CPO = CPO_1.CPO WHERE CPO_D1.CPO ='" & CPOS.Text & "'"
    ...
    Private Sub busca_cpos()
        dt = New DataTable()
        Dim strSQL As String = "SELECT * FROM CPO_1 WHERE CPO =  '" & CPOS.Text & "'"
        llena_tablas(dt, strSQL, cna)
    ...
    Private Sub busca_detalle()
        ...
        Dim dr As DataRow
        dt = New DataTable()
        Dim strSQL As String = "SELECT * FROM CPO_D1 LEFT JOIN CPO_1 ON CPO_D1.CPO = CPO_1.CPO WHERE CPO_D1.CPO =  '" & CPOS.Text & "' AND ESTILO = '" & Estilos.Text & "' AND COLOR = '" & COLORES.Text & "'"
        llena_tablas(dt, strSQL, cna)
        For Each dr In dt.Rows
    ...
    Private Sub graba_copito()
        ...
        strsql = "SELECT CPO_1.CLIENTE,CPO_D1.CPO,CPO_D1.ESTILO,CPO_D1.COLOR, CODIGO,COLOR_TELA,ESCALA,XS,S,M,L,XL,XL2,XL3,XL4,XL5,XL6,TOTAL,MINIMO_P,MAXIMO_P FROM CPO_D1 LEFT JOIN CPO_1 ON CPO_D1.CPO = CPO_1.CPO LEFT JOIN CONSUMO_TELA ON CPO_1.CLIENTE = CONSUMO_TELA.CLIENTE AND CPO_D1.ESTILO = CONSUMO_TELA.ESTILO_CPO AND CPO_D1.COLOR = CONSUMO_TELA.COLOR_CPO WHERE CPO_D1.CPO = '" & CPOS.Text & "' AND ESTILO = '" & Estilos.Text & "' AND COLOR = '" & COLORES.Text & "'"
        llena_tablas(dt, strsql, cna)
        ...
        Try
            strsql = "DELETE CPO_PYTHON WHERE CPO = '" & CPOS.Text & "' AND ESTILO = '" & Estilos.Text & "' AND COLOR = '" & COLORES.Text & "'"
            ...
            For Each dr In dt.Rows
                ...
                col = col + CStr(dr(19)) + "')"
                ' ================ DETALLE ====================
                strsql = "INSERT INTO CPO_PYTHON (EMPRESA,CLIENTE,CPO,ESTILO,COLOR,CODIGO_TELA,COLOR_TELA,ESCALA,T0,T1,T2,T3,T4,T5,T6,T7,T8,T9,TOTAL,MINIMO,MAXIMO) " & _
                             "VALUES ( '" & obj.numero & "','" & col
    ...
    Private Sub graba_registro()
        ...
        Try
            ...
            strsql = "UPDATE CPO_1 SET CLIENTE = " & "'" & CLIENTES.Text & "'" & _
                                 " , F_PEDIDO = " & "'" & fecha1 & "'" & _
                                 " , F_ENTREGA = " & "'" & fecha2 & "'" & _
                                 " WHERE CPO = '" & CPOS.Text & "'"
            comando.CommandText = strsql
            afectados = comando.ExecuteNonQuery()
            If afectados = 0 Then
                strsql = "INSERT INTO CPO_1 (CPO,CLIENTE,F_PEDIDO,F_ENTREGA) " & _
                         "VALUES ( '" & CPOS.Text & "','" & _
                             CLIENTES.Text & "','" & _
                             fecha1 & "','" & _
                             fecha2 & "')"
            ...
            ' ================ DETALLE ====================
            strsql = "UPDATE CPO_D1  SET ESTILO = " & "'" & Estilos.Text & "'" & _
            ...
            afectados = comando.ExecuteNonQuery()
            If afectados = 0 Then
                strsql = "INSERT INTO CPO_D1 (CPO,ESTILO,COLOR,XS,S,M,L,XL,XL2,XL3,XL4,XL5,XL6,TOTAL,F_ENTREGA,F_PROMETIDA,DESTINO,C1,C2,C3,C4,C5,C6,C7,C8,C9,C0,FECHA,USUARIO,VENDEDOR,COMISION,ESCALA,MINIMO_P,MAXIMO_P) " & _
                         "VALUES ( '" & CPOS.Text & "','" & _
                             Estilos.Text & "','" & _
                             COLORES.Text & "','" & _
                             ta(1, 1) & "','" & _
    ...
    Private Sub elimina()
        ...
        Try
            strsql = "DELETE FROM CPO_D1 WHERE CPO = '" & CPOS.Text & "' AND ESTILO = '" & Estilos.Text & "' AND COLOR = '" & COLORES.Text & "'"
            comando.CommandText = strsql
            afectados = comando.ExecuteNonQuery()
    ...
    Private Sub elimina_copito(ByVal tipo As String)
        Dim strsql As String
        Dim afectados As Integer
        Dim cnn As New SqlClient.SqlConnection
        cnn.ConnectionString = cs.get_mtp()
        ...
        comando.Transaction = transaccion
        If tipo = "T" Then
            strsql = "DELETE FROM CPO_PYTHON WHERE CPO = '" & CPOS.Text & "'"
        Else
            strsql = "DELETE FROM CPO_PYTHON WHERE CPO = '" & CPOS.Text & "' AND ESTILO = '" & Estilos.Text & "' AND COLOR = '" & COLORES.Text & "'"
        End If
    ...
    Private Sub elimina_todo()
        ...
        Try
            strsql = "DELETE FROM CPO_D1 WHERE CPO = '" & CPOS.Text & "'"
            comando.CommandText = strsql
            afectados = comando.ExecuteNonQuery()

            strsql = "DELETE FROM CPO_1 WHERE CPO = '" & CPOS.Text & "'"
            comando.CommandText = strsql
            afectados = comando.ExecuteNonQuery()
