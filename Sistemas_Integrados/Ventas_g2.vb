...
Public Class Ventas_g2
    ...
    Private Sub crea_tabla()
        ...
        fecha_entrega(dt)
        strsql = "SELECT * FROM PUSH01 WHERE CLIENTE + CPO +ESTILO + COLOR IN (SELECT CLIENTE + CPO_D.CPO + ESTILO + COLOR FROM CPO_D LEFT JOIN CPO ON CPO_D.CPO = CPO.CPO WHERE ESTADO = 'A') ORDER BY CLIENTE,ESTILO,COLOR,FECHA_P DESC "
