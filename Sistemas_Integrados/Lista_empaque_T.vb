...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Lista_empaque_T))
        ...
        Me.Label1.Text = "Inventario Terceras"
        '
        'Lista_empaque_T
        '
        ...
        Me.Name = "Lista_empaque_T"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Lista de Empaque Terceras "
...
#End Region
    ...
    Private Sub llena_cortes()
        llena_tablas(co, "SELECT * FROM CAJAS01 LEFT JOIN CORTES ON CAJAS01.CORTE = CORTES.CORTE WHERE TIPO_SEG IN ('3','8','12') AND ESTADO = 'T' ORDER BY CAJAS01.CORTE", cnn)
    End Sub
    ...
    Private Sub sigue_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles sigue.Click
        ...
        If ok Then
            ...
            fecha.Enabled = False
            fg.Rows.Count = 150
            embarque.Text = "JST-" & embarque.Text
            llena_fj()
    ...
    Private Sub graba_datos()
        ...
        Try
            For i = 1 To fg.Rows.Count - 1
                For j = 5 To 14
                    ...
                    If prendas > 0 Then
                        ...
                        '================================ STOCK ===========================
                        strsql = "UPDATE STOCK SET UNIDADES = UNIDADES - " & prendas & " WHERE ESTILO = '" & fg(i, 3) & "' AND COLOR = '" & fg(i, 4) & "' AND TIPO = '02' AND TALLA = '" & talla & "'"
                        comando.CommandText = strsql
                        afectados = comando.ExecuteNonQuery()

                        strsql = "UPDATE E_STOCK SET EXPORT = EXPORT + " & prendas & " WHERE CORTE = '" & fg(i, 2) & "' AND ESTILO = '" & fg(i, 3) & "' AND COLOR = '" & fg(i, 4) & "' AND TIPO = '02' AND TALLA = '" & talla & "'"
                        comando.CommandText = strsql
                        afectados = comando.ExecuteNonQuery()

                        strsql = "UPDATE S_STOCK SET PRENDAS = PRENDAS + " & prendas & " WHERE EMBARQUE = '" & embarque.Text & "' AND ESTILO = '" & fg(i, 3) & "' AND COLOR = '" & fg(i, 4) & "' AND TIPO = '02' AND TALLA = '" & talla & "' AND CLIENTE = 'JT' AND CPO = '" & embarque.Text & "'"
                        comando.CommandText = strsql
                        afectados = comando.ExecuteNonQuery()
            ...
            For i = 1 To gr.Rows.Count - 1
                ...
                "VALUES ('" & embarque.Text & "','" & gr(i, 1) & "','Ter','" & _
                              embarque.Text & "','" & _
                              gr(i, 2) & "','" & _
                              gr(i, 3) & "','" & _
                              fechas & "','JST','" & _
