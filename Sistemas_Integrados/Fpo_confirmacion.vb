...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Fpo_confirmacion))
        ...
        Me.Name = "Fpo_confirmacion"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Ingresa Fecha de Confirmacion FPO"
...
#End Region
    ...
    Private Sub llena_fg()
        ...
        Dim dr As DataRow
        Dim strSQL As String = "SELECT FPO.*,F_CONFIRMADA FROM FPO LEFT JOIN FPO_CONFIRMADA ON FPO.FPO = FPO_CONFIRMADA.FPO AND FPO.TIPO = FPO_CONFIRMADA.TIPO AND FPO.KNIT = FPO_CONFIRMADA.KNIT AND FPO.COLOR = FPO_CONFIRMADA.COLOR AND FPO.LOTE = FPO_CONFIRMADA.LOTE WHERE FPO.STATUS = 'ABIERTO' AND CLIENTE = '" & clientes.Text & "'"
            ...
            For i = 1 To fg.Rows.Count - 1
                If fg(i, 7) = True Then
                    Try
                        ...
                        strsql = "UPDATE FPO_CONFIRMADA SET F_CONFIRMADA = '" & fec & "' WHERE FPO = '" & fg(i, 1) & "' AND TIPO = '" & fg(i, 2) & "' AND KNIT = '" & fg(i, 3) & "' AND COLOR = '" & fg(i, 4) & "' AND LOTE = '" & fg(i, 5) & "'"
                        comando.CommandText = strsql
                        afectados = comando.ExecuteNonQuery()
                        If afectados = 0 Then
                            strsql = "INSERT INTO FPO_CONFIRMADA (FPO,TIPO,KNIT,COLOR,LOTE,F_CONFIRMADA) VALUES ('" & _
                                                   fg(i, 1) & "','" & _
                                                   fg(i, 2) & "','" & _
                                                   fg(i, 3) & "','" & _
                                                   fg(i, 4) & "','" & _
