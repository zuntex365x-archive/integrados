...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Lista_empaque_pr))
        ...
        Me.Name = "Lista_empaque_pr"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Lista de Empaque Primeras"
...
#End Region
    ...
    Private Sub llena_es()
        ...
        Dim l As Integer = 1
        Dim dt As New DataTable()
        llena_tablas(dt, "SELECT DISTINCT EMBARQUE, FECHA  FROM PACKING_E WHERE EMBARQUE = CPO AND EMBARQUE LIKE 'JTP-%' ORDER BY FECHA DESC", cnn)
    ...
    Private Sub Print_fg()
        ...
        fg.PrintGrid("Packing List", PrintGridFlags.FitToPageWidth + PrintGridFlags.ShowPreviewDialog, "Packing List (Firsts)  Shipment: " + embarque.Text + Chr(9) + Chr(9) + "Page {0}", "Shipment date: " + fechas)
        ...
        su.PrintGrid("Packing List", PrintGridFlags.FitToPageWidth + PrintGridFlags.ShowPreviewDialog, "Packing List (Firsts)  Shipment: " + embarque.Text + Chr(9) + Chr(9) + "Page {0}", "Shipment date: " + fechas)
    End Sub
