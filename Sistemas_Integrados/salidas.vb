...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'Tipo
        '
        Me.Tipo.Items.AddRange(New Object() {"Devolucion al Proveedor", "Separar Cuellos/Puños", "Muestras"})
        ...
        Me.Text = "Salidas del  Inventario"
    ...
    Private Sub graba_documento()
        ...
        Try
            ...
            For i = 1 To fg.Rows.Count - 1
                ...
                client & "','" & fpo & "','" & cpo & "','00000','" & yardas & "','" & libras & "','" & precio & "')"
                comando.CommandText = strSQL
                afectados = comando.ExecuteNonQuery()
                ...
                If tmovto = 5 Then
                    ...
                    colo = fg(i, 5)
                    ' =================== TEXTILERA
                    strSQL = "UPDATE FPO SET  STATUS = 'ABIERTO' , RECIBIDAS = RECIBIDAS -  '" & libras & "' WHERE FPO = '" & fpo & "' AND KNIT = '" & knit & "' AND COLOR = '" & colo & "' AND TIPO = '" & tipon & "' AND LOTE = '" & batch & "'"
                    comando.CommandText = strSQL
                    afectados = comando.ExecuteNonQuery()
                End If
            Next
