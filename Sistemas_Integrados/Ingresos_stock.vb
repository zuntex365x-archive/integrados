...
Public Class Ingresos_Stock
    ...
    Dim path As String = "c:\reportes\e_Stock.xls"
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Ingresos_Stock))
        ...
        Me.Estados.Items.AddRange(New Object() {"Primeras", "Segundas", "Terceras"})
        ...
        Me.fg.Location = New System.Drawing.Point(2, 75)
        Me.fg.Name = "fg"
        ...
        Me.Name = "Ingresos_Stock"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Reporte de Ingresos a Inventario de Stock por Corte"
        Me.ToolTip1.SetToolTip(Me, "Reporte de Ingresos a Stock")
...
#End Region
    ...
    Private Sub setea_grid()
        ...
        fg.Cols(5).Name = "ESTILO"
        fg.Cols(6).Name = "COLOR"
        fg.Cols(7).Name = "CLIENTE"
        fg.Cols(8).Name = "PRENDAS"
    ...
    Private Sub llena_grid()
        ...
        ok = False
        Dim tipo As String
        Dim strSQL As String = "SELECT * FROM E_STOCK WHERE FECHA BETWEEN '" & fecha & "' AND '" & fecha1 & "' ORDER BY FECHA,CORTE"
        ...
        For Each dr In dt.Rows
            ...
            tipo = dr("TIPO")
            Try
                fg(lineas, 3) = Estados.Items(tipo)
            Catch
            End Try
