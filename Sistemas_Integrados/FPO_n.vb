...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FPO_n))
        ...
        Me.Button1.Location = New System.Drawing.Point(853, 8)
        ...
        Me.Label23.Location = New System.Drawing.Point(762, 24)
...
#End Region
    ...
    Private Sub FPO_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        llena_combos(C4, "SELECT DISTINCT CLIENTE FROM CPO_D LEFT JOIN CPO ON CPO.CPO = CPO_D.CPO WHERE ESTADO = 'A' AND CLIENTE <> 'THE NORTH FACE' ORDER BY CLIENTE", "CLIENTE")
    ...
    Private Sub llena_grid()
        ...
        Dim dr As DataRow
        ok = False
        Dim strSQL As String = "SELECT * FROM FPO WHERE FPO.FPO = '" & FPC.Text & "'"  'STATUS = 'ABIERTO'"
    ...
    Private Sub llena_colores()
        llena_combos(C3, "SELECT * FROM COLORES WHERE CLIENTE = '" & C4.Text & "' ORDER BY COLOR", "COLOR")
    End Sub
    ...
    Private Sub lee_registro()
        Dim dt As New DataTable()
        Dim dr As DataRow
        Dim strSQL As String = "SELECT * FROM FPO WHERE FPO = '" & FPC.Text & "' AND TIPO = '" & c0.Text & "' AND " & _
                                    "KNIT = '" & c2.Text & "' AND COLOR = '" & C3.Text & "' AND LOTE = '" & LOTES & "'"
        llena_tablas(dt, strSQL, cnn)
