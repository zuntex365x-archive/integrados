...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.E1.Location = New System.Drawing.Point(1043, 19)
        Me.E1.Name = "E1"
...
#End Region
    ...
    Private Sub llena_corte()
        ...
        If co.Rows.Count > 0 Then
            ...
            revisa_cliente_usuario(cliente, ok)
            If Not ok Then
                MsgBox("No esta autorizado para Modificar datos de este Cliente", MsgBoxStyle.Critical, "Corte con otro Cliente")
                limpia_variables()
                Exit Sub
            End If
            Try
    ...
    Private Sub elimina_upc()
        ...
        Try
            ...
            '============== actualiza  =======================
            strsql = "DELETE UPC WHERE CLIENTE = '" & cliente & "' AND ESTILO = '" & estilo.Text & "' AND COLOR = '" & colo.Text & "'"
            comando.CommandText = strsql
            afectados = comando.ExecuteNonQuery()
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles E1.Click
        Dim seguro As MsgBoxResult
