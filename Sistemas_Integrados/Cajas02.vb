...
#End Region
    Private Sub Cortes_status(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        End Try
        '  Dim ok As Boolean
        '  ok = imprime_cajas("ZU0005698", "ZU0005698")
        limpia_variables()
    End Sub
            ...
            For i = 1 To fg.Rows.Count - 1
                ...
                If afectados = 0 Then
                    strsql = "INSERT INTO CAJAS01 (CAJA,CORTE,TALLA,TIPO,UNIDADES,CLIENTE,UBICACION,FECHA,ESTADO,ESCALA,ORDEN,IMPRESO,TIPO_SEG,SECCION) VALUES ('" & _
                                                   pre + Format(corre + 1, h) & "','" & corte.Text & "','" & _
                                                   fg(i, 3) & "','" & tipo & "','" & _
                                                   fg(i, 6) & "','" & cliente & "','00',GETDATE(),'P','" & _
                    ...
                    Try
                        strsql = "INSERT INTO CAJAS04 (CAJA,CORTE,TALLA,TIPO,UNIDADES,FECHA ,QUIEN) " & _
                                     "VALUES ( '" & pre + Format(corre + 1, h) & "','" & corte.Text & "','" & _
                                                    fg(i, 3) & "','" & tipo & "','" & _
                                                    fg(i, 6) & "',GETDATE() ,'" &
                                                    obj.usuario & "')"
                        comando.CommandText = strsql
