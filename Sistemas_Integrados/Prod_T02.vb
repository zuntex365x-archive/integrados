...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Prod_T02))
        ...
        Me.cajad.Location = New System.Drawing.Point(199, 70)
        Me.cajad.Name = "cajad"
        ...
        Me.tallad.Location = New System.Drawing.Point(199, 141)
        ...
        Me.tipod.Location = New System.Drawing.Point(199, 105)
        Me.tipod.Name = "tipod"
        ...
        Me.unid.Location = New System.Drawing.Point(199, 175)
        Me.unid.Name = "unid"
        ...
        Me.GroupBox2.Size = New System.Drawing.Size(468, 217)
        ...
        Me.Text = "PT - Traslado de unidades entre Cajas"
...
#End Region
    ...
    Private Sub llena_corte()
        llena_tablas(co, "SELECT PROD_TER01.* FROM PROD_TER01 WHERE CORTE = '" & corte.Text & "'", cnn)
        llena_combos(cajad, "SELECT DISTINCT CAJA FROM PROD_TER01 ORDER BY CAJA", "CAJA")
    ...
    Private Sub cajad_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles cajad.SelectedIndexChanged
        ...
        llena_combos(cajan, "SELECT DISTINCT CAJA FROM PROD_TER01 WHERE CAJA <> '" & cajad.Text & "' ORDER BY CAJA", "CAJA")
    End Sub
    ...
    Private Sub sigue_Click(sender As System.Object, e As System.EventArgs) Handles sigue.Click
        ...
        agrega_fg(ok)
        If Not ok Then
            MsgBox("No pueden haber dos registros dentro una misma Caja con Talla y Tipo de prenda repetidos.", MsgBoxStyle.Critical, "Por favor revise !!!")
            Exit Sub
        End If
    ...
    Private Sub elimina_linea()
        ...
        'Try
        ok = modifica_caja(co, fg(l, 1), fg(l, 2), fg(l, 3), fg(l, 6) * -1, orden, unid.Text)
        fg.Rows.Remove(l)
        unidn.Text = 0
        cajad.Focus()
        'Catch
    ...
    Private Sub graba_datos()
        ...
        Try
            ...
            For i = 1 To fg.Rows.Count - 1
                ...
                strsql = "UPDATE PROD_TER01 SET UNIDADES = UNIDADES + '" & fg(i, 6) & "' WHERE CAJA = '" & fg(i, 5) & "' AND CORTE = '" & fg(i, 7) & "' AND TALLA = '" & fg(i, 3) & "' AND TIPO = '" & fg(i, 2) & "'"
                comando.CommandText = strsql
                afectados = comando.ExecuteNonQuery()
                If afectados = 0 Then
                ...
                strsql = "UPDATE PROD_TER01 SET UNIDADES = UNIDADES - '" & fg(i, 6) & "' WHERE CAJA = '" & fg(i, 1) & "' AND CORTE = '" & fg(i, 7) & "' AND TALLA = '" & fg(i, 3) & "' AND TIPO = '" & fg(i, 2) & "'"
                comando.CommandText = strsql
                afectados = comando.ExecuteNonQuery()
                ...
                strsql = "INSERT INTO PROD_TER02 (TIPO_MOVTO,NO_DOCTO,CAJA,CORTE,TALLA,TIPO,DESCRIPCION,FECHA,UNIDADES,USUARIO) VALUES ('S','" & _
                                                   ...
                                                   fg(i, 3) & "','" & _
                                                   fg(i, 2) & "','" & _
                                                   "TRASLADO A CAJA " & fg(i, 5) & "',GETDATE(),'" & _
                                                   fg(i, 6) & "','" & _
                                                   obj.usuario & "')"
                comando.CommandText = strsql
                afectados = comando.ExecuteNonQuery()
