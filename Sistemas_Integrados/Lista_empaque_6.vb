...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Lista_empaque_6))
        ...
        Me.CANCELA.Location = New System.Drawing.Point(766, 7)
        ...
        Me.fecha.Location = New System.Drawing.Point(440, 10)
        Me.fecha.Name = "fecha"
        ...
        Me.embarque.Location = New System.Drawing.Point(104, 8)
        Me.embarque.MaxLength = 11
        Me.embarque.Name = "embarque"
        Me.embarque.Size = New System.Drawing.Size(208, 26)
        Me.embarque.TabIndex = 1
        Me.ToolTip1.SetToolTip(Me.embarque, "Embarque  JTP-XXXXXXX")
        '
        'gr
        '
        ...
        Me.sigue.Location = New System.Drawing.Point(766, 7)
        Me.sigue.Name = "sigue"
        ...
        Me.empres.Location = New System.Drawing.Point(597, 10)
        ...
        Me.Label4.Location = New System.Drawing.Point(368, 7)
        ...
        Me.Label1.Text = "Inventario Primeras"
        '
        'Lista_empaque_6
        '
        ...
        Me.Name = "Lista_empaque_6"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Lista de Empaque Primeras JT"
...
#End Region
    ...
    Private Sub llena_cortes()
        llena_tablas(co, "SELECT * FROM E_STOCK WHERE (PRENDAS - EXPORT) > 0 AND TIPO = '00'", cnn)
    End Sub
    ...
    Private Sub sigue_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles sigue.Click
        ...
        If ok Then
            ...
            fecha.Enabled = False
            fg.Rows.Count = 150
            embarque.Text = "JTP-" & embarque.Text
            llena_fj()
        Else
    ...
    Private Sub graba_datos()
        ...
        Try
            For i = 1 To fg.Rows.Count - 1
                For j = 5 To 14
                    ...
                    If prendas > 0 Then
                        ...
                        '================================ STOCK ===========================
                        strsql = "UPDATE STOCK SET UNIDADES = UNIDADES - " & prendas & " WHERE ESTILO = '" & fg(i, 3) & "' AND COLOR = '" & fg(i, 4) & "' AND TIPO = '00' AND TALLA = '" & talla & "'"
                        comando.CommandText = strsql
                        afectados = comando.ExecuteNonQuery()

                        strsql = "UPDATE E_STOCK SET EXPORT = EXPORT + " & prendas & " WHERE CORTE = '" & fg(i, 2) & "' AND ESTILO = '" & fg(i, 3) & "' AND COLOR = '" & fg(i, 4) & "' AND TIPO = '00' AND TALLA = '" & talla & "'"
                        comando.CommandText = strsql
                        afectados = comando.ExecuteNonQuery()

                        strsql = "UPDATE S_STOCK SET PRENDAS = PRENDAS + " & prendas & " WHERE EMBARQUE = '" & embarque.Text & "' AND ESTILO = '" & fg(i, 3) & "' AND COLOR = '" & fg(i, 4) & "' AND TIPO = '00' AND TALLA = '" & talla & "' AND CLIENTE = 'JT' AND CPO = '" & embarque.Text & "'"
                        comando.CommandText = strsql
                        afectados = comando.ExecuteNonQuery()
            ...
            For i = 1 To gr.Rows.Count - 1
                ...
                afectados = comando.ExecuteNonQuery()
                If afectados = 0 Then
                    strsql = "INSERT INTO PACKING_E (EMBARQUE,CPO,ESTILO,COLOR,CAJA_I,CAJA_F,FECHA,DESTINO,FACTURA,CONTENEDOR,MATPRI,FACTURADO,NFSHIP,FECHA_CREACION,FACTURA_CLIENTE,E_FACTURA) " & _
                                                    "VALUES ('" & embarque.Text & "','" & _
                                                                  embarque.Text & "','" & _
                                                                  gr(i, 2) & "','" & _
                                                                  gr(i, 3) & "','" & _
                ...
                "VALUES ('" & embarque.Text & "','" & gr(i, 1) & "','Pri','" & _
                              embarque.Text & "','" & _
                              gr(i, 2) & "','" & _
                              gr(i, 3) & "','" & _
                              fechas & "','JT','" & _
