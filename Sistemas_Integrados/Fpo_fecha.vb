...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Fpo_fecha))
        ...
        Me.G1.Location = New System.Drawing.Point(960, 0)
        Me.G1.Name = "G1"
        ...
        Me.fg.Size = New System.Drawing.Size(1205, 640)
        ...
        Me.Button1.Location = New System.Drawing.Point(912, 0)
        ...
        Me.Label2.Location = New System.Drawing.Point(380, 5)
...
#End Region
    ...
    Private Sub llena_fg()
        ...
        Dim dr As DataRow
        Dim strSQL As String = "SELECT FPO,TIPO,KNIT,COLOR,LOTE,CLIENTE,TEXTILERA,OFECHA,LIBRAS,RECIBIDAS FROM FPO WHERE CLIENTE = '" & clientes.Text & "' AND STATUS = 'ABIERTO' "
    ...
    Private Sub graba_datos()
        ...
        Try
            For i = 1 To fg.Rows.Count - 1
                If (fg(i, 9) <> fg(i, 10)) Then
                    fecha1 = Format(CDate(fg(i, 9)), "yyyy-MM-dd")
                    strsql = "UPDATE FPO SET OFECHA = '" & fecha1 & "'  WHERE FPO = '" & fg(i, 1) & "' AND TIPO = '" & fg(i, 2) & "' AND KNIT = '" & fg(i, 3) & "' AND COLOR = '" & fg(i, 4) & "' AND LOTE = '" & fg(i, 5) & "'"
            ...
            If fecha1 <> "" Then
                Try
                    strsql = "INSERT INTO FPO_OFECHA (CLIENTE,FECHA,USUARIO) VALUES ('" & clientes.Text & "',GETDATE(),'" & obj.usuario & "')"
                    comando.CommandText = strsql
                    afectados = comando.ExecuteNonQuery()
                Catch
                End Try
