...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Estado_m1))
...
#End Region
    ...
    Private Sub llena_Grid(ByRef ok As Boolean)
        ...
        Dim i As Integer
        ok = True
        STRSQL = "SELECT ROLLOS.*,ESTADO_TELA, DESCRIPCION FROM ROLLOS LEFT JOIN ESTADOS_TELA ON ACTIVO = ESTADOS_TELA.CODIGO LEFT JOIN CODIGO_TELA ON ROLLOS.CODIGO = CODIGO_TELA.CODIGO WHERE CLIENTE = '" & client.SelectedItem & "' AND YARDAS > 0 AND ACTIVO NOT IN ('S','0')"
    ...
    Private Sub Estado_Tela()
        Dim dt As New DataTable()
        Dim dr As DataRow
        Dim strSQL As String = "SELECT * FROM ESTADOS_TELA WHERE CODIGO = '0'"
        llena_tablas(dt, strSQL, cnn)
        For Each dr In dt.Rows
