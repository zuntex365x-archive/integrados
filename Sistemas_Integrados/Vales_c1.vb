...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Vales_c1))
        ...
        Me.Text = "Consulta de vales Emitidos  (por fecha)"
...
#End Region
    ...
    Private Sub llena_grid()
        ...
        Dim dr As DataRow
        Dim strSQL As String = "SELECT * FROM VALES WHERE FECHA BETWEEN '" & fecha & "' AND '" & fecha1 & "' ORDER BY FECHA,CORTE,VALE"
    ...
    Private Sub Print_fg()
        ...
        mal = obj.nombre + "  Reporte de Vales emitidos desde " + Format(CDate(fecha_i.Text), "dd/MM/yyyy") + " al " + Format(CDate(fecha_f.Text), "dd/MM/yyyy")
