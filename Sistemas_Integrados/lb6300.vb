...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(lb6300))
...
#End Region
    Private Sub lb6300_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub comienza_lectura()
        ...
        Dim l As Integer
        Try
            retval = Shell("c:\lector\Unitech\ptcomm /comport:" & puerto.Text & " /ptaddr:a /batch:c:\lector\Unitech\bajar_t.txt /exit", AppWinStyle.Hide)
        Catch
        End Try
        While ok
            Try
                infoReader = My.Computer.FileSystem.GetFileInfo("C:\TEXPASA\INVSUN.TXT")
                l = infoReader.Length
                If l > 0 Then
                    ok = False
                End If
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Else
            Try
                File.Delete("c:\texpasa\INVSUN.TXT")
