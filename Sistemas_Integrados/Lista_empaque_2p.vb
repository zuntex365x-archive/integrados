...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Lista_empaque_2p))
...
#End Region
    ...
    Private Sub crea_linea(ByRef talla As String, ByRef c As Integer, ByRef l As Integer)
        ...
        fg(l, 3) = dw("ESTILO")
        fg(l, 4) = dw("CPO")
        codigo = get_codigo_color("PERRY ELLIS", dw("COLOR"))
        fg(l, 5) = codigo + " - " & dw("COLOR")
    End Sub

    Private Sub encabezado(ByVal dw As DataRow)
