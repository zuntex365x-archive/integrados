...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Prendas_exportac))
        ...
        Me.fg.Size = New System.Drawing.Size(944, 360)
        ...
        Me.Label4.Location = New System.Drawing.Point(649, 72)
        Me.Label4.Name = "Label4"
        Me.Label4.Size = New System.Drawing.Size(175, 32)
        Me.Label4.TabIndex = 62
        Me.Label4.Text = "Prendas x Exportar:"
        ...
        Me.Coser.Location = New System.Drawing.Point(824, 72)
        Me.Coser.Name = "Coser"
        ...
        Me.Name = "Prendas_exportac"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Detalle de Prendas Exportadas"
...
#End Region
    ...
    Private Sub llena_cortes()
        Dim total As Object
        Dim strSQL As String = "SELECT CPO,ESTILO,COLOR,CORTES_E.* FROM CORTES_E,CORTES WHERE CORTES_E.CORTE = CORTES.CORTE AND CPO = '" & Cpo.Text & "' AND ESTILO = '" & Estilo.Text & "' AND COLOR = '" & Colo.Text & "'"
        Dim da As System.Data.SqlClient.SqlDataAdapter
        da = New System.Data.SqlClient.SqlDataAdapter(strSQL, cnn1)
        Dim ds As DataSet
        Dim dr As DataRow
        ...
        For Each dr In ds.Tables("PRENDAS").Rows
            ...
            Try
                total = emb.Compute("MAX(FECHA)", "CORTE = '" & dr("CORTE") & "'")
                fg(lineas, 1) = CDate(total)
            Catch
            End Try
            foundrows = emb.Select("CORTE = '" & dr("CORTE") & "'")
            Try
                dtr = foundrows(0)
                fg(lineas, 14) = dtr("EMBARQUE")
            Catch
            End Try
        Next
    End Sub

    Private Sub exportacion_stock()
        Dim dt As New DataTable()
        Dim dr As DataRow
        Dim i As Integer
        Dim l As Integer = fg.Rows.Count
        Dim strSQL As String = "SELECT * FROM S_STOCK WHERE CPO = '" & Cpo.Text & "' AND ESTILO = '" & Estilo.Text & "' AND COLOR = '" & Colo.Text & "' AND TIPO = '00'"
        Dim te(10) As String
        te = Split("XS,S,M,L,XL,2XL,3XL,4XL,5XL,6XL,TOTAL", ","c)
        ...
        For Each dr In dt.Rows
            fg(l, 1) = dr("FECHA")
            fg(l, 14) = dr("EMBARQUE")
            i = Array.IndexOf(te, dr("TALLA"))
            If i > -1 Then
                fg(l, i + 3) = fg(l, i + 3) + dr("PRENDAS")
                fg(l, 13) = fg(l, 13) + dr("PRENDAS")
            End If
        Next
    End Sub
    ...
    Private Sub llena_fechas()
        Dim strsql As String = "SELECT CPO,ESTILO,COLOR,EMBARQUES.* FROM EMBARQUES,CORTES WHERE EMBARQUES.CORTE = CORTES.CORTE AND CPO = '" & Cpo.Text & "' AND ESTILO = '" & Estilo.Text & "' AND COLOR = '" & Colo.Text & "'"
        llena_tablas(emb, strsql, cnn1)
    End Sub
