...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Lista_empaque_t1))
...
#End Region
    ...
    Private Sub llena_es()
        ...
        Dim l As Integer = 1
        Dim dt As New DataTable()
        llena_tablas(dt, "SELECT DISTINCT EMBARQUE, FECHA  FROM PACKING_E WHERE LEFT(EMBARQUE,3) = 'JST'ORDER BY FECHA DESC", cnn)
    ...
    Private Sub Print_fg()
        Dim fechas As String = Format(fecha.Value, "MMM-dd-yyyy")
        ...
        fg.PrintParameters.FooterFont = New Font("Arial Narrow", 14, FontStyle.Italic)
        fg.PrintGrid("Packing List", PrintGridFlags.FitToPageWidth + PrintGridFlags.ShowPreviewDialog, "Packing List (Terceras)  Shipment: " + embarque.Text + Chr(9) + Chr(9) + "Page {0}", "Recibido por: ________________ " & Chr(9) & "Shipment date: " + fechas)
        ...
        su.PrintGrid("Packing List", PrintGridFlags.FitToPageWidth + PrintGridFlags.ShowPreviewDialog, "Packing List (Irregulars)  Shipment: " + embarque.Text + Chr(9) + Chr(9) + "Page {0}", "Recibido por: ________________ " & Chr(9) & "Shipment date: " + fechas)
    End Sub
