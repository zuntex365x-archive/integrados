...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Cortes_ad2))
        ...
        Me.Button3.Location = New System.Drawing.Point(352, 8)
        ...
        Me.CANCELA.Location = New System.Drawing.Point(272, 8)
        ...
        Me.cpo.Name = "cpo"
        Me.cpo.Size = New System.Drawing.Size(164, 24)
        Me.cpo.TabIndex = 72
        '
        'Label11
        '
        ...
        Me.fg.Location = New System.Drawing.Point(5, 56)
        Me.fg.Name = "fg"
        Me.fg.Rows.Count = 1
        Me.fg.Rows.DefaultSize = 19
        Me.fg.SelectionMode = C1.Win.C1FlexGrid.SelectionModeEnum.Row
        Me.fg.Size = New System.Drawing.Size(1000, 528)
        ...
        Me.Text = "Procesos Adicionales por CPO"
...
#End Region
    ...
    Private Sub llena_grid()
        ...
        Dim l As Integer = 1
        Dim strsql As String = "SELECT * FROM CORTES_PAR WHERE CPO = '" & cpo.Text & "' ORDER BY FECHA,CORTE,PROCESO,TIPO,DOCTO"
    ...
    Private Sub Print_fg()
        ...
        mal = obj.nombre + "  Procesos Adicionales del CPO: del " + cpo.Text
    ...
    Private Sub llena_cpos()
        ...
        Dim dr As DataRow
        cpo.Items.Clear()
        llena_tablas(da, "SELECT DISTINCT CPO FROM CORTES_PAR ORDER BY CPO", cnn)
        For Each dr In da.Rows
            cpo.Items.Add(dr("CPO"))
        Next
        If cpo.Items.Count > 0 Then
            cpo.SelectedIndex = 0
        End If
    End Sub
