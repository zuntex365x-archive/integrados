...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Estilos_d_corte))
        ...
        Me.Name = "Estilos_d_corte"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Ingresa No: de días entre Corte - Producción "
    ...
    Private Sub graba_datos()
        ...
        Try
            For i = 1 To fg.Rows.Count - 1
                If fg(i, 4) <> fg(i, 5) Then
                    strsql = "UPDATE ESTILOS_CORTE SET DIAS_CORTE = '" & fg(i, 4) & "' WHERE ESTILO = '" & fg(i, 1) & "'"
                    comando.CommandText = strsql
                    afectados = comando.ExecuteNonQuery()
                    If afectados = 0 Then
                        strsql = "INSERT INTO ESTILOS_CORTE (ESTILO,DIAS_CORTE) VALUES ('" & fg(i, 1) & "','" & fg(i, 4) & "')"
                        comando.CommandText = strsql
                        afectados = comando.ExecuteNonQuery()
                    End If
                    strsql = "INSERT INTO ESTILOS_CORTE_V (FECHA,USUARIO,ESTILO,DIAS_CORTE) VALUES (GETDATE(),'" & obj.usuario & "','" & fg(i, 1) & "','" & fg(i, 4) & "')"
                    comando.CommandText = strsql
                    afectados = comando.ExecuteNonQuery()
                End If
            Next
