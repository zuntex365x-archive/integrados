...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(Listado_ingresos))
        ...
        Me.tipo.Items.AddRange(New Object() {"TODOS", "COMPRA", "DEVOLUCIONES", "AJUSTES"})
        ...
        Me.Name = "Listado_ingresos"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Reporte de Ingresos a Inventario"
...
#End Region
    ...
    Private Sub setea_grid(ByVal strsql As String)
        Try
            ...
            fg.Cols(5).Caption = "BATCH"
            fg.Cols(6).Caption = "ROLLO"
            fg.Cols(7).Caption = "KNIT"
            fg.Cols(8).Caption = "COLOR"
            fg.Cols(9).Caption = "CPO"
            fg.Cols(10).Caption = "YARDAS"
            fg.Cols(11).Caption = "LIBRAS"
            fg.Cols(12).Caption = "COSTO LB."
            fg.Cols(13).Caption = "COSTO T."
            fg.Cols(14).Caption = "TEXTILERA"
            fg.Cols(15).Caption = "CORTE"
            fg.Cols(16).Caption = "TONALIDAD"
    ...
    Private Sub asigna_Valores()
        ...
        strSQL = "SELECT FECHA,DMOVTO.CLIENTE,TMOVTO,DOCTO,DMOVTO.BATCH,DMOVTO.ROLLO,KNIT ,COLOR, DMOVTO.CPO,DMOVTO.YARDAS,LIBRAS, PRECIO, (PRECIO*LIBRAS) AS CTOTAL,(SELECT DISTINCT TEXTILERA FROM FPO WHERE FPO.FPO = DMOVTO.FPO) AS  TEXTILERA,CORTE, TONALIDAD FROM DMOVTO LEFT JOIN ROLLOS ON DMOVTO.BATCH = ROLLOS.BATCH AND DMOVTO.ROLLO = ROLLOS.ROLLO WHERE ROLLOS.TIPO = 'TELA' AND FECHA BETWEEN '" & fecha_i & "' AND '" & fecha_f & "' AND TMOVTO < '4' "
    ...
    Private Sub Print_fg()
        ...
        fg.PrintGrid("Telas", PrintGridFlags.FitToPageWidth + PrintGridFlags.ShowPrintDialog, "Reporte de Ingresos a Bodega de Tela" + Chr(9) + Chr(9) + "Pagina {0}", "")
    End Sub
