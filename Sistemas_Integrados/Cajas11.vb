...
#End Region
    ...
    Private Sub FPO_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'llena_combos(seccion, "SELECT SECCION FROM SECCIONES WHERE SECCION LIKE 'TEXS%'", "SECCION")
        llena_combos(seccion, "SELECT SECCION FROM SECCIONES WHERE SECCION LIKE 'TEX%' OR SECCION LIKE 'INNO%'", "SECCION")
        setea_grid()
        Try
