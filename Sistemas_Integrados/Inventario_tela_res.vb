...
Public Class Inventario_tela_res
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Inventario_tela_res))
        ...
        Me.Button1.Location = New System.Drawing.Point(680, 8)
        ...
        Me.Name = "Inventario_tela_res"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Inventario de Tela con Reserva"
...
#End Region
    ...
    Private Sub setea_busqueda()
        ...
        If Trim(C4.Text) = "TODOS" Then
            StrSQL = "SELECT ROLLOS.BATCH,CLIENTE,FPO,CPO,KNIT,COLOR,YFIBER,ROLLOS.ROLLO,ROLLOS.YARDAS,(ROLLOS.PESO/YARDAS_I)*ROLLOS.YARDAS AS LIBRAS, ESTADO_TELA, ANCHO, TONALIDAD,ROLLOS.CODIGO, DESCRIPCION ,(SELECT TOP(1) TEXTILERA FROM FPO WHERE FPO = ROLLOS.FPO) AS TEXTILERA  , BODEGAS.BODEGA, (SELECT TOP 1 REQ_D.CORTE FROM REQ_D WHERE REQ_D.DESPACHADO = 'N' AND REQ_D.BATCH = ROLLOS.BATCH AND REQ_D.ROLLO = ROLLOS.ROLLO) CORTE, VIEJO FROM ROLLOS  LEFT JOIN CODIGO_TELA ON CODIGO_TELA.CODIGO = ROLLOS.CODIGO LEFT JOIN ESTADOS_TELA ON ESTADOS_TELA.CODIGO = ACTIVO LEFT JOIN BODEGAS ON ROLLOS.BODEGA = BODEGAS.CODIGO WHERE ROLLOS.YARDAS >0 AND TIPO = 'TELA'"
        Else
            StrSQL = "SELECT ROLLOS.BATCH,CLIENTE,FPO,CPO,KNIT,COLOR,YFIBER,ROLLOS.ROLLO,ROLLOS.YARDAS,(ROLLOS.PESO/YARDAS_I)*ROLLOS.YARDAS AS LIBRAS, ESTADO_TELA, ANCHO, TONALIDAD, ROLLOS.CODIGO, DESCRIPCION ,(SELECT TOP(1) TEXTILERA FROM FPO WHERE FPO = ROLLOS.FPO) AS TEXTILERA  , BODEGAS.BODEGA, (SELECT TOP 1 REQ_D.CORTE FROM REQ_D WHERE REQ_D.DESPACHADO = 'N' AND REQ_D.BATCH = ROLLOS.BATCH AND REQ_D.ROLLO = ROLLOS.ROLLO) CORTE , VIEJO FROM ROLLOS  LEFT JOIN CODIGO_TELA ON CODIGO_TELA.CODIGO = ROLLOS.CODIGO LEFT JOIN ESTADOS_TELA ON ESTADOS_TELA.CODIGO = ACTIVO LEFT JOIN BODEGAS ON ROLLOS.BODEGA = BODEGAS.CODIGO WHERE CLIENTE = '" & C4.Text & "' AND ROLLOS.YARDAS >0 AND TIPO = 'TELA'"
        End If
        If Estado.Text <> "TODOS" Then
            ...
            End If
        End If
        StrSQL = StrSQL + " ORDER BY ROLLOS.BATCH, ROLLOS.ROLLO "
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        llena_hoja(ok)
        If ok Then
            MsgBox("Sus datos fueron trasladados a Excel en el directorio:  C:\reportes  bajo el nombre de Inventario_res ", MsgBoxStyle.OkOnly, "TRASLADO DE DATOS ")
            Close()
        Else
            subtotales()
        End If
    ...
    Private Sub llena_hoja(ByRef ok As Boolean)
        Dim path As String = "c:\reportes\inventario_res.xls"
        Try
